...
/** 比较两media是否相同 */
export function isSameMediaItem(a: ICommon.IMediaBase | null | undefined, b: ICommon.IMediaBase | null | undefined) {
  return a && b && a.id == b.id && a.platform === b.platform;
}

/** 查找是否存在 */
export function includesMedia(a: ICommon.IMediaBase[] | null | undefined, b: ICommon.IMediaBase | null | undefined) {
  if (!a || !b) {
    return false;
  }
