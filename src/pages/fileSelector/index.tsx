...
import { ExternalStorageDirectoryPath, readDir, getAllExternalFilesDirs, exists } from 'react-native-fs';
...
export default function FileSelector() {
  ...
  const selectPath = useCallback((item: IFileItem | IFileItem[], nextChecked: boolean) => {
    if (multi) {
  ...
  const currentPageAllChecked = useMemo(() => {
    return filesData.length && filesData.every(file => checkedPaths.includes(file.path));
