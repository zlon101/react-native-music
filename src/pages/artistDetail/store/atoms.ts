...
export interface IQueryResult<T extends IArtist.ArtistMediaType = IArtist.ArtistMediaType> {
  state?: RequestStateCode;
  page?: number;
  data?: ICommon.SupportMediaItemBase[T];
}

type IQueryResults<K extends IArtist.ArtistMediaType = IArtist.ArtistMediaType> = {
