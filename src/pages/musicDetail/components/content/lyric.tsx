    ...
    <View style={globalStyle.fwflex1}>
      ...
      {draggingIndex !== undefined && (
        <View
          ...
          <DraggingTime time={(lyric[draggingIndex]?.time ?? 0) + +(meta?.offset ?? 0)} />
...
function DraggingTime(props: { time: number }) {
  ...
  return <Text style={style.draggingTimeText}>{timeformat(Math.min(props.time, progress.duration ?? 0))}</Text>;
}
