...
export default function Operations() {
  ...
  const musicIndexInFav = favoriteMusicSheet?.musicList.findIndex(_ => isSameMediaItem(_, musicItem)) ?? -1;
  ...
  return (
    <View
      ...
      <Pressable
        onPress={() => {
          ...
          showPanel('MusicQuality', {
            ...
            async onQualityPress(quality) {
              const changeResult = await MusicQueue.changeQuality(quality);
              if (!changeResult) {
        ...
        <Image source={ImgAsset.quality[currentQuality]} style={style.quality} />
      </Pressable>
      <Icon
