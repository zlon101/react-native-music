declare namespace IPlugin {
  ...
  interface IPluginDefine {
    ...
    /** 根据主键去查询歌曲信息 */
    getMusicInfo?: (musicBase: ICommon.IMediaBase) => Promise<Partial<IMusic.IMusicItem> | null>;
    /** 获取歌词 */
    getLyric?: (musicItem: IMusic.IMusicItemBase) => Promise<ILyric.ILyricSource | null>;
    /** 获取专辑信息，里面的歌曲分页 */
    getAlbumInfo?: (albumItem: IAlbum.IAlbumItemBase, page: number) => Promise<IAlbumInfoResult | null>;
    /** 获取歌单信息，有分页 */
    getMusicSheetInfo?: (sheetItem: IMusic.IMusicSheetItem, page: number) => Promise<ISheetInfoResult | null>;
    /** 获取作品，有分页 */
