          ...
          <View style={styles.container}>
            <GestureDetector gesture={slComposed}>
              <View
                style={[
                  styles.slContainer,
                  {
                    backgroundColor: Color.hsl(currentHue, 100, 50).toString(),
                  },
                ]}>
                <LinearGradient
                  start={{ x: 0, y: 0 }}
                ...
                <View
                  style={[
                    styles.slThumb,
                    {
                      ...
                      backgroundColor: currentColor.toString(),
                    },
                  ]}
                />
              </View>
            ...
            <GestureDetector gesture={alphaComposed}>
              <LinearGradient
                ...
                colors={[currentColor.toString(), currentColor.alpha(0).toString()]}
                style={[styles.hueContainer, styles.alphaContainer]}>
                <View
                  style={[
                    styles.hueThumb,
                    {
            ...
            <View style={[styles.showBar]}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor: currentColorWithAlpha.toString(),
                  },
                ]}
              />
            </View>
            <ThemeText style={styles.colorStr}>{currentColorWithAlpha.rgb().hexa().toString()}</ThemeText>
          </View>
        </>
      )}
    />
