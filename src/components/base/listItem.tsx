...
function ListItemText(props: IListItemTextProps) {
  ...
  return (
    <View style={[styles.actionBase, defaultStyle, containerStyle]}>
      <ThemeText fontSize={fontSize} style={contentStyle} fontWeight={fontWeight} {...contentProps}>
        {children}
      </ThemeText>
    </View>
  );
...
function ListItemIcon(props: IListItemIconProps) {
  ...
  const innerContent = (
    <View style={[styles.actionBase, defaultStyle, containerStyle]}>
      <Icon name={icon} size={iconSize} style={contentStyle} color={colors.text} />
    </View>
  );
...
function ListItemImage(props: IListItemImageProps) {
  const { uri, fallbackImg, position = 'left', fixedWidth, width, containerStyle, contentStyle } = props;
  ...
  return (
    <View style={[styles.actionBase, defaultStyle, containerStyle]}>
      <FastImage style={[styles.leftImage, contentStyle]} uri={uri} emptySrc={fallbackImg} />
    </View>
  );
}
...
export function ListItemHeader(props: { children?: ReactNode }) {
  ...
  return (
    <ListItem withHorizonalPadding heightType="smallest" style={styles.listItemHeader}>
