...
const toastConfig = {
  success: ({ text1 }: any) => <ToastBase text={text1} iconName="check-circle" iconColor="#457236" />,
  warn: ({ text1 }: any) => <ToastBase text={text1} iconName="alert-circle" iconColor="#de7622" />,
};
